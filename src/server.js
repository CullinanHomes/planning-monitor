...
app.get('/api/stats', auth, async function(req, res) {
  ...
  res.json({total:total,thisWeek:thisWeek,noAgent:noAgent,pipeline:pipeline,archived:archived,pendingPost:pendingPost,contacted:contacted,contactRate:contactRate,avgDaysToContact:avgDaysToContact,stageCounts:stageCounts,newCount:newCount,winRate:winRate});
});
