...
app.get('/api/land', auth, async function(req, res) {
  ...
  else if (due==='upcoming') withActions=withActions.filter(function(s){return !s.nextAction.overdue && s.nextAction.label.indexOf('due')>-1;});
...
var LAND_EDITABLE_FIELDS = ['type','address','area','council','notes',
  ...
  'doorknock1_date','doorknock2_date'];
